...
- controlled access to locations
- atmosphere over action
- lore discovered through fragments, not exposition
...
- systems that still function, but without explanation

These remains are known simply as **Relics**.

They do not tell a story directly.
They only leave traces.

---

## Lore: The Call

Some relic systems never fully shut down.

They emit faint, repeating signals — not messages, but **requests for synchronization**.
A pattern.
A pull.

This phenomenon is known as **The Call**.

The Call is not intentional.
It does not ask for help.
It does not promise reward.

It exists because the system was never completed.
...
The story is not delivered as a linear plot.

Instead, it unfolds through:
- environmental storytelling
- system logs
- relic interfaces
- subtle changes in system behavior

Some answers are never given directly.
...
**Call of Relics: Orbital Silence** is a game about listening.

Not to characters.
Not to instructions.

But to what remains when history is gone,
and only systems are left behind.
