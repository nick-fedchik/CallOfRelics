...
**Обмеження Фази 0:**
- Двигуни — лише візуальні ефекти (EnginesService v0.1)
...
**Умова переходу до Фази 1:** реалізація EnginesService та EnergyService.
...
flowchart TB
    ...
    P0 -->|"EnginesService +<br/>EnergyService"| P1
