...
├── SF_REFERENCES.md       ← Літературні SF-референси — індекс (55 авторів)
├── SF_REFERENCES-1950-1979.md ← Золота доба та Нова хвиля (32 автори)
├── SF_REFERENCES-1980-1999.md ← Кіберпанк та Сучасна класика (14 авторів)
├── SF_REFERENCES-2000-2020.md ← Сучасна SF (9 авторів)
...
### SF_REFERENCES — Літературні SF-референси

**Аналіз науково-фантастичної літератури як джерел натхнення.** Версія 2.0 — 55 авторів, 4 файли.

**Структура:**

- [SF_REFERENCES.md](SF_REFERENCES.md) — Індекс та зведені таблиці, наративна формула
- [SF_REFERENCES-1950-1979.md](SF_REFERENCES-1950-1979.md) — Золота доба та Нова хвиля (32 автори)
- [SF_REFERENCES-1980-1999.md](SF_REFERENCES-1980-1999.md) — Кіберпанк та Сучасна класика (14 авторів)
- [SF_REFERENCES-2000-2020.md](SF_REFERENCES-2000-2020.md) — Сучасна SF (9 авторів)

**Ключові автори:** Лем, Кларк, Стругацькі, Сімак, Шеклі, Азімов, Герберт, Дік, Ле Ґуїн, Бредбері, Гібсон, Стерлінг, Бенкс, Сіммонс, Віндж, Батлер, Іган, Воттс, Рейнольдс, Лю Цісінь та інші
...
flowchart TB
    ...
    GDD -->|джерела| SFREF[📖 SF_REFERENCES<br/>55 авторів, 4 файли]
...
| SF-референси (індекс) | [SF_REFERENCES.md](SF_REFERENCES.md) |
| SF-референси: 1950-1979 | [SF_REFERENCES-1950-1979.md](SF_REFERENCES-1950-1979.md) |
| SF-референси: 1980-1999 | [SF_REFERENCES-1980-1999.md](SF_REFERENCES-1980-1999.md) |
| SF-референси: 2000-2020 | [SF_REFERENCES-2000-2020.md](SF_REFERENCES-2000-2020.md) |
...
- 1.7: SF_REFERENCES розширено до 55 авторів, розбито на 4 файли за періодами
