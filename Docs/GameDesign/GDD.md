...
# 6. КОСМІЧНИЙ КОРАБЕЛЬ (SPACE SHIP)
...
Впливає на:
- роботу сканерів і інших приладів
...
Є обмеженим за обсягом і може покращуватися.
...
Тут Гравець може просканувати планету і знайти додаткові локації.
Також на орбіти Гравець може запустити Міжпланетний Локатор і знайти інші планети,
що випромінюють загадкові сигнали
...
- нові локації отримують статус **Виявлена**
...
## 9.2. Міжпланетний Локатор

Міжпланетний Локатор використовується для виявлення
інших планет у космічному просторі.

Він дозволяє:
- знаходити нові планети що випромінюють загадковий сигнал
...
### Небезпечних зон (Exploration Zone)
- основна ігрова територія
- зони ризику та активних механік
- можуть містити пастки, NPC або аномалії

Гравець завжди починає дослідження локації з Landing Zone.

---

## 11.4. Фізична присутність як умова дослідження

Локація не вважається дослідженою, поки гравець фізично не перебував у її межах.
...
Лише **присутність і взаємодія** дозволяють зарахувати прогрес.

---

# 12. ПЛАНЕТНІ ЛОКАЦІЇ ЯК АРКАДНІ ІГРИ

Дослідження локацій реалізовано у форматі окремих аркадних ігрових сценаріїв.
...
Залежно від сценарію локації, гравець може виконувати такі дії:
...
Ігрова смерть можлива у межах планетної локації внаслідок:
- небезпечних умов
- пасток
- дій NPC або істот
...
Альтернативний сценарій: Гравець спавниься в кабіні пілота Корабля на планетній локації
...
## 18.2. Планетні локації планети «Біллі Рубін»
